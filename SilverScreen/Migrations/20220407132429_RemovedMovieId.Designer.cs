...
namespace SilverScreen.Migrations
{
    ...
    [Migration("20220407132429_RemovedMovieId")]
    partial class RemovedMovieId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SilverScreen.Models.Tables.UserCommentReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "ReportId" }, "ReportIDFK");

                    b.HasIndex(new[] { "UserId" }, "UserFKCR1");

                    b.ToTable("UserCommentReports");
                });
            ...
            modelBuilder.Entity("SilverScreen.Models.Tables.CommentReport", b =>
                {
                    b.HasOne("SilverScreen.Models.Tables.Movie", null)
            ...
            modelBuilder.Entity("SilverScreen.Models.Tables.UserCommentReport", b =>
                {
                    b.HasOne("SilverScreen.Models.Tables.CommentReport", "Report")
                        .WithMany("UserCommentReports")
            ...
            modelBuilder.Entity("SilverScreen.Models.Tables.CommentReport", b =>
                {
                    b.Navigation("UserCommentReports");
                });
