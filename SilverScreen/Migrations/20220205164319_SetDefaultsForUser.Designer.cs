...
namespace SilverScreen.Migrations
{
    ...
    [Migration("20220205164319_SetDefaultsForUser")]
    partial class SetDefaultsForUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SilverScreen.Models.Tables.Genre", b =>
                {
                    ...
                    b.HasIndex(new[] { "MovieId" }, "GMovieFK");
            ...
            modelBuilder.Entity("SilverScreen.Models.Tables.WatchedMovie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MovieId" }, "WMovieFK");

                    b.HasIndex(new[] { "UserId" }, "WUserFK");
            ...
            modelBuilder.Entity("SilverScreen.Models.Tables.staff", b =>
                {
                    ...
                    b.HasIndex(new[] { "MovieId" }, "StaffMovieFK");
